...
<div class="row">
  ...
  if($row["price_euro"] == 0 AND $row["price_cent"] == 0 OR $row["price_cent"] > 99){
   ...
   ?>
  <div class="col-md-6"style="text-align:right;"><?php echo $row["price_euro"] .",".$row["price_cent"]." €";?> <button class="btn btn-link" name="arikelID" value="<?php echo $row["artikel_id"];?>"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true" style="color:green;"></span></button></div>
<?php } ?>
</div>
